...
public class CreateTransportOrderAction
  ...
  /**
   * Provides panels for entering new transport orders.提供输入新运输订单的面板
   */
  ...
  public CreateTransportOrderAction(TransportOrderUtil orderUtil,
    ...
    System.out.println("*************TransportOrderAction Creates a new instance*****************");
  ...
  public void createTransportOrder() {
    ...
    System.out.println("-----TransportOrder actionPerformed----");
