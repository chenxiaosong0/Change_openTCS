...
/**
 * Triggers creation of a batch of orders after a given timeout. 在给定超时后触发一批订单的创建。
 */
public class TimeoutOrderGenTrigger
  ...
  /**
   * The instance actually creating the new orders. 实际创建新订单的实例。
   */
  private final OrderBatchCreator orderBatchCreator;
  /**
   * The actual task triggering order generation. 触发订单生成的实际任务。
   */
