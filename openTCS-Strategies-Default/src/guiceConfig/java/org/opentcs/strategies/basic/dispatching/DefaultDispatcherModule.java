...
import org.opentcs.drivers.MyVehicleCommAdapterFactory;
...
public class DefaultDispatcherModule
  ...
  protected void configure() {
    ...
    bindDispatcher(DefaultDispatcher.class);//依赖注入DefaultDispatcher
//    vehicleCommAdaptersBinder().addBinding().to(MyVehicleCommAdapterFactory.class);
  }
